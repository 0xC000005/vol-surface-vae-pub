"""
Out-of-sample VAE prior generation test for backfill_16yr model.
...
Expected: Higher CI violations due to prior mismatch (~30-35% vs ~28% oracle)

Tests on out-of-sample data (indices 5001-5821, 2019-2023).
"""
import numpy as np
import torch
...
print("=" * 80)
print("VAE PRIOR GENERATION TEST - backfill_16yr (OUT-OF-SAMPLE)")
print("=" * 80)
print()
...
print(f"\nTest Configuration:")
print(f"  Test period: indices [{test_start}, {test_end}] (2019-2023, OOS)")
...
output_file = "models_backfill/vae_prior_oos_16yr.npz"
...
print()
print("=" * 80)
print("VAE PRIOR GENERATION COMPLETE (OUT-OF-SAMPLE)")
print("=" * 80)
print()
...
print()
print("Next step: Run evaluate_vae_prior_ci_oos_16yr.py")
