...
rmse_recon = np.load("models_backfill/insample_reconstruction_16yr.npz")
...
output_file = "models_backfill/vae_health_16yr.npz"
...
# Save summary CSV
summary_csv = "models_backfill/vae_health_summary_16yr.csv"
