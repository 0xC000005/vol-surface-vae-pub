...
Output:
    - models_backfill/backfill_context60_short_phase3_ep299.pt
    - models_backfill/backfill_context60_short_phase4_ep349.pt
    - models_backfill/backfill_context60_short_best.pt (best validation)
    - models_backfill/context60_training_log_resume_phase3.txt
"""
...
def main():
    ...
    if not os.path.exists(phase2_checkpoint_path):
        raise FileNotFoundError(
            ...
            f"Expected location: models_backfill/backfill_context60_short_phase2_ep249.pt"
        )
