...
@dataclass
class HierarchicalPartialResidualRetrievalConfig:
    top_k: int = 16
    sample_temperature: float = 0.2
    residual_center_alpha: float = 0.5


class HierarchicalPartialResidualRetrievalScenarioGenerator(torch.nn.Module):
    """279b-v0: fixed Stage A center path plus partially centered residual retrieval scenarios."""
    ...
    def __init__(
        ...
        self.cfg = HierarchicalPartialResidualRetrievalConfig(
            top_k=top_k,
    ...
    def sample_batched(
        ...
        **_: object,
        ...
        scenarios = torch.clamp(center_expand + adjusted_residuals, 0.0, 1.0)
...
def load_model(checkpoint_path: str, device: torch.device):
    ...
    model = HierarchicalPartialResidualRetrievalScenarioGenerator(
        base_model,
