...
class DeterministicLearnedRetrievalLocalHistoryTwoTimescaleMixedQueryDeltaBackbone(torch.nn.Module):
    """287e-v0: local fast query channel with globally anchored slow query channel."""
...
def load_model(
    checkpoint_path: str,
    device: torch.device,
) -> tuple[DeterministicLearnedRetrievalLocalHistoryTwoTimescaleMixedQueryDeltaBackbone, dict]:
