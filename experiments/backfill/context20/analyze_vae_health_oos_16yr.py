...
rmse_recon = np.load("models/backfill/oos_reconstruction_16yr.npz")
...
output_file = "models/backfill/vae_health_oos_16yr.npz"
...
# Save summary CSV
summary_csv = "models/backfill/vae_health_summary_oos_16yr.csv"
