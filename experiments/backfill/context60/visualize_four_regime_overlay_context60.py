"""
Visualize Four-Regime CI Width Overlay - Context60 Model
...
anomalous patterns and intelligent confidence with extended context length
...
**Context60 specifics:**
- Context length: 60 days (vs 20 for context20)
- Forecast horizon: 30 days (same as context20)
...
Output:
    results/context60_baseline/visualizations/comparison/four_regime_overlay_prior_context60.png
"""
...
def load_tf_predictions(sampling_mode):
    ...
    """
    pred_file = f"results/context60_baseline/predictions/teacher_forcing/{sampling_mode}/vae_tf_insample_h30.npz"
...
def create_four_regime_overlay(green_data, blue_data, orange_data, red_data,
    ...
    ax.set_title('Context60 CVAE Conditional Generation: Four Regime Comparison\n'
                 'Demonstrating Intelligent Pattern Recognition with 60-Day Context',
...
def main():
    ...
    output_path = output_dir / "four_regime_overlay_prior_context60.png"
