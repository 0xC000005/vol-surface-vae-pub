...
Output:
    - models/backfill/backfill_context60_short_phase2_ep209.pt
    - models/backfill/backfill_context60_short_phase3_ep219.pt
    - models/backfill/backfill_context60_short_phase4_ep229.pt
    - models/backfill/backfill_context60_short_best.pt (best validation)
    - models/backfill/context60_training_log_resume.txt
"""
