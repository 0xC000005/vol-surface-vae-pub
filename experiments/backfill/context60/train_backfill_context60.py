...
Output:
    - models/backfill/backfill_context60_phase1_ep199.pt
    - models/backfill/backfill_context60_phase2_ep349.pt
    - models/backfill/backfill_context60_phase3_ep474.pt
    - models/backfill/backfill_context60_phase4_ep599.pt
    - models/backfill/backfill_context60_best.pt (best validation)
    - models/backfill/context60_training_log.txt
"""
