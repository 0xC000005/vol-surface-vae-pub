#!/usr/bin/env python3
"""
Latent Information Bottleneck Analysis for Latent12 V2 Model

This script analyzes the latent12 V2 model (with corrected KL weight) to verify
that the over-regularization issue was fixed.

V1 Results (FAILURE):
- PC1 variance: 99.27% (over-compressed)
- Correlation: 0.113 (weak, 67% worse than baseline)
- Effective dimensionality: 8.3% (severe under-utilization)
- KL divergence: 0.854 (collapsed posterior)

V2 Expected Improvements:
- PC1 variance: < 95% (better distribution)
- Correlation: > 0.35 (recovery to baseline or better)
- Effective dimensionality: > 15% (better utilization)
- KL divergence: 2-5 (healthy range)
"""
...
OUTPUT_DIR = PROJECT_ROOT / "results" / "context60_baseline" / "analysis_v2" / "day1_over_dispersion"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

print("=" * 80)
print("LATENT INFORMATION BOTTLENECK ANALYSIS - LATENT12 V2 (CORRECTED)")
print("=" * 80)
print()
