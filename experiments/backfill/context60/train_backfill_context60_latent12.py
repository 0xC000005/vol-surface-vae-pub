"""
Context=60 2-Phase Training with Latent Bottleneck Fix
...
Output:
    - models/backfill/context60_experiment/checkpoints/backfill_context60_latent12_phase1_ep199.pt
    - models/backfill/context60_experiment/checkpoints/backfill_context60_latent12_phase2_ep599.pt
    - models/backfill/context60_experiment/checkpoints/backfill_context60_latent12_best.pt (best validation)
    - models/backfill/context60_experiment/checkpoints/context60_latent12_training_log.txt
"""
...
from config.backfill_context60_config_latent12 import BackfillContext60ConfigLatent12

# Parse command-line arguments
parser = argparse.ArgumentParser(description='Train Context60 Latent12 model')
...
def main():
    ...
    cfg = BackfillContext60ConfigLatent12
    ...
    # Open log file
    log_file = open(f"{output_dir}/context60_latent12_training_log.txt", "w")
    log_file.write("Context=60 Latent12 2-Phase Training Log\n")
    log_file.write("="*80 + "\n\n")
