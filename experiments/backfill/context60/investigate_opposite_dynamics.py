...
HORIZON = 90
ATM_6M = (2, 2)
OUTPUT_DIR = Path("results/context60_baseline/analysis/opposite_dynamics_investigation")
...
def load_all_data():
    ...
    # Oracle predictions
    oracle_file = f"results/context60_baseline/predictions/teacher_forcing/oracle/vae_tf_insample_h{HORIZON}.npz"
    ...
    # Prior predictions
    prior_file = f"results/context60_baseline/predictions/teacher_forcing/prior/vae_tf_insample_h{HORIZON}.npz"
