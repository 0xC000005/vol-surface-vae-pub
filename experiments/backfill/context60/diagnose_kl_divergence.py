"""
Diagnostic script to compute KL divergence and loss components for latent12 model.

This script loads the trained latent12 model and computes the detailed loss
breakdown on validation data to diagnose potential over-regularization.
"""
...
from config.backfill_context60_config_latent12 import BackfillContext60ConfigLatent12 as cfg
...
print("=" * 80)
print("KL DIVERGENCE DIAGNOSTIC FOR LATENT12 MODEL")
print("=" * 80)
print(f"Model: {MODEL_PATH}")
print(f"Config: latent_dim={cfg.latent_dim}, kl_weight={cfg.kl_weight}")
