"""
Visualize Four-Regime CI Width Overlay - Context60 Latent12 V2 (H=90)
...
context with 90-day forecast horizon.

**Purpose**: Demonstrate latent12_v2 model's pattern recognition persistence
across longer forecast horizons (90 days vs 30 days)
...
**Context60 Latent12 V2 H=90 specifics:**
...
Usage:
    PYTHONPATH=. python experiments/backfill/context60/visualize_four_regime_overlay_latent12v2_h90.py

Output:
    results/context60_latent12_v2/visualizations/comparison/four_regime_overlay_prior_latent12v2_h90.png
"""
...
def load_tf_predictions(sampling_mode):
    ...
    """
    pred_file = f"results/context60_latent12_v2/predictions/teacher_forcing/{sampling_mode}/vae_tf_insample_h90.npz"
...
def create_four_regime_overlay(green_data, blue_data, orange_data, red_data,
    ...
    subtitle_text = (
        'Latent12 V2 Model: Natural divergence persists over extended horizon (+296% spread growth) | '
        'Day-90 width: 1.08× GT (vs baseline\'s 0.82× under-dispersion)'
    )
    ax.text(0.5, 0.985,
            subtitle_text,
    ...
    ax.set_title('Context60 Latent12 V2: Four Regime Comparison (H=90)\n'
                 'Demonstrating Pattern Recognition Persistence with 90-Day Forecast',
...
def main():
    ...
    print("=" * 80)
    print("LATENT12 V2: FOUR REGIME COMPARISON (H=90)")
    ...
    output_path = output_dir / "four_regime_overlay_prior_latent12v2_h90.png"
    ...
    print(f"    - Natural divergence persists (+296% spread growth)")
    print(f"    - Day-90 width: 1.08× GT (oracle), 1.03× GT (prior)")
    print(f"    - Pattern recognition remains evident across extended horizon")
    print()
