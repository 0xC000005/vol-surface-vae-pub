#!/usr/bin/env python
"""
263b-v0: 263a with bounded history-mean EC baseline.
"""
...
from diffusion.block_ar.joint_state_space_latent_factor_fm_ec import (
    JointStateSpaceLatentFactorFMEC,
    JointStateSpaceLatentFactorFMECConfig,
    save_checkpoint,
)
...
def fm_step(
    model: JointStateSpaceLatentFactorFMEC,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="263b-v0 263a + bounded history-mean EC")
    ...
    cfg = JointStateSpaceLatentFactorFMECConfig(
    ...
    model = JointStateSpaceLatentFactorFMEC(cfg).to(device)
