...
from diffusion.block_ar.empirical_normal_score_path_diffusion import (
    EmpiricalNormalScorePathDiffusion,
    EmpiricalNormalScorePathDiffusionConfig,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="354a empirical normal-score full-path denoising diffusion"
    )
    ...
    parser.add_argument("--mixer_type", choices=["axial", "transformer"], default="transformer")
    ...
    model = EmpiricalNormalScorePathDiffusion(cfg).to(device)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        rec = {
            ...
            "val_noisy_future_std": val_avg["noisy_future_std"],
        ...
        print(
            ...
            f"noisy_std={rec['val_noisy_future_std']:.3f} "
