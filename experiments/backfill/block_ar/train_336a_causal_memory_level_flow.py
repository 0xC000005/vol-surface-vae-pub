...
from diffusion.block_ar.causal_memory_level_flow_matching import (
    CausalMemoryLevelFMConfig,
    CausalMemoryLevelFlowMatching,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="336a causal memory next-level flow")
    ...
    model = CausalMemoryLevelFlowMatching(cfg).to(device)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        rec = {
            ...
            "train_level_std": train_avg["level_std"],
