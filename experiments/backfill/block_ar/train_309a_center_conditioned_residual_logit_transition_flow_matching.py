...
from diffusion.block_ar.center_conditioned_residual_logit_transition_flow_matching import (
    CenterConditionedResidualLogitTransitionFlowMatching,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="309a-v0 center-conditioned residual joint flow matching"
    )
    ...
    model = CenterConditionedResidualLogitTransitionFlowMatching(cfg).to(device)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        rec = {
            ...
            "val_center_transition_std": val_avg["center_transition_std"],
            "val_residual_std": val_avg["residual_std"],
            "val_residual_abs": val_avg["residual_abs"],
        ...
        print(
            ...
            f"total_std={rec['val_total_transition_std']:.3f} "
