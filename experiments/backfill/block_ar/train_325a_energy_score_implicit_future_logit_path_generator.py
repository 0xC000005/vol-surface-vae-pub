...
from diffusion.block_ar.energy_score_implicit_future_logit_path_generator import (
    EnergyScoreImplicitFutureLogitPathGenerator,
    EnergyScoreImplicitPathGeneratorConfig,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="325a-v0 energy-score implicit future-logit path generator"
    )
