...
def main() -> None:
    parser = argparse.ArgumentParser(description="269a-v0 autoregressive next-change flow matching")
    ...
    model = ARChangeFlowMatching(cfg).to(device)
