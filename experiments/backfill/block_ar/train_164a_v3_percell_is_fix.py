#!/usr/bin/env python
"""
164a_v3_percell_is_fix: Per-Cell CLN + Corrected Interval Score (alpha=0.1)
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"164a_v3_percell_is_fix: Per-Cell CLN + Corrected IS (alpha=0.1)")
    print(f"{'='*60}")
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        # ── Save best model ──
        config_dict = {
            "type": "ar_spatial_transformer_164a_v3_percell_is_fix",
            "encoder": {
