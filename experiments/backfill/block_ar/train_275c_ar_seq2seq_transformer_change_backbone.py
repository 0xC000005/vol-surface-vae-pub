...
from diffusion.block_ar.ar_seq2seq_transformer_change_backbone import (
    ARSeq2SeqTransformerChangeBackbone,
    ARSeq2SeqTransformerConfig,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="275c-v0 deterministic seq2seq transformer next-change backbone"
    )
    ...
    model = ARSeq2SeqTransformerChangeBackbone(cfg).to(device)
