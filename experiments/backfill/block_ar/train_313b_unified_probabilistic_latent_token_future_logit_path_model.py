...
from diffusion.block_ar.unified_probabilistic_latent_token_future_logit_path_model import (
    UnifiedProbabilisticLatentTokenFutureLogitPathConfig,
    UnifiedProbabilisticLatentTokenFutureLogitPathModel,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="313b-v0 unified probabilistic latent-token future-logit path model"
    )
    parser.add_argument("--context_dim", type=int, default=160)
    parser.add_argument("--history_hidden", type=int, default=96)
    parser.add_argument("--encoder_dropout", type=float, default=0.1)
    parser.add_argument("--latent_tokens", type=int, default=6)
    ...
    parser.add_argument("--prior_hidden", type=int, default=128)
    ...
    model = UnifiedProbabilisticLatentTokenFutureLogitPathModel(cfg).to(device)
