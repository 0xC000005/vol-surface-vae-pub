...
from diffusion.block_ar.empirical_normal_score_scalar_ar_mixture_density import (
    EmpiricalNormalScoreScalarARMixtureConfig,
    EmpiricalNormalScoreScalarARMixtureDensity,
    save_checkpoint,
)
...
def main() -> None:
    ...
    parser.add_argument("--use_same_cell_feedback", action=argparse.BooleanOptionalAction, default=True)
    ...
    model = EmpiricalNormalScoreScalarARMixtureDensity(cfg).to(device)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        print(
            ...
            f"val={rec['val_total']:.5f} target_std={rec['val_target_std']:.3f} "
            f"target_abs={rec['val_target_abs']:.3f} scale={rec['val_scale_mean']:.3f} "
            f"mean_abs={rec['val_mean_abs_err']:.3f} "
