...
def main() -> None:
    parser = argparse.ArgumentParser(description="278b-v0 adaptive hierarchical retrieval scenario generator")
    parser.add_argument("--base_checkpoint", type=str, default="models/backfill/277d_v0_s42/best_model.pt")
    parser.add_argument("--top_k", type=int, default=16)
    parser.add_argument("--base_temperature", type=float, default=0.2)
