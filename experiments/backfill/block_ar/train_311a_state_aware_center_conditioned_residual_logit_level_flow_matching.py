...
from diffusion.block_ar.center_conditioned_state_aware_residual_logit_level_flow_matching import (
    StateAwareCenterConditionedResidualLogitLevelFlowMatching,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="311a-v0 state-aware center-conditioned residual logit-level flow matching"
    )
    ...
    model = StateAwareCenterConditionedResidualLogitLevelFlowMatching(cfg).to(device)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        rec = {
            ...
            "val_center_logit_std": val_avg["center_logit_std"],
            "val_residual_std": val_avg["residual_std"],
            "val_total_logit_std": val_avg["total_logit_std"],
            "val_total_transition_std": val_avg["total_transition_std"],
        ...
        print(
            ...
            f"val={rec['val_total']:.5f} residual_std={rec['val_residual_std']:.3f} "
            f"total_transition_std={rec['val_total_transition_std']:.3f} "
