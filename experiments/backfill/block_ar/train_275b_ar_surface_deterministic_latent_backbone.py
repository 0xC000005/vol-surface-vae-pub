...
from diffusion.block_ar.ar_surface_deterministic_latent_backbone import (
    ARSurfaceDeterministicLatentBackbone,
    ARSurfaceDeterministicLatentConfig,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="275b-v0 deterministic latent-state backbone with explicit observation model"
    )
    ...
    parser.add_argument("--latent_dropout", type=float, default=0.1)
    ...
    model = ARSurfaceDeterministicLatentBackbone(cfg).to(device)
