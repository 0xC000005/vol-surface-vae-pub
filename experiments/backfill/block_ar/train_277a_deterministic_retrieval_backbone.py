...
def make_library(
    ...
    return hist_norm.cpu(), train_future.cpu(), h, w, h * w


def main() -> None:
    parser = argparse.ArgumentParser(description="277a-v0 deterministic retrieval Stage A backbone")
    ...
    library_history_norm, library_future_01, h, w, d = make_library(
