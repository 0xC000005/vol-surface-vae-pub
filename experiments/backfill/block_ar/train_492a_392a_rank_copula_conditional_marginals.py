...
from diffusion.block_ar.rank_copula_conditional_marginal_model import (
    RankCopulaConditionalMarginalConfig,
    RankCopulaConditionalMarginalModel,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "492a: learned conditional marginal quantiles with frozen 392a rank copula"
        )
    )
    ...
    model = RankCopulaConditionalMarginalModel(cfg).to(device)
        ...
        for hist_01, fut_01 in loader:
            ...
            with torch.set_grad_enabled(train_mode):
                ...
                if train_mode:
                    ...
                    optimizer.step()
            sums["total"] = sums.get("total", 0.0) + float(loss.item())
    ...
    print(f"Base rank-copula source: {args.base_model_type} {args.base_checkpoint}")
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        rec = {
            ...
            "val_q90_width": val_avg["q90_width"],
            "val_median_abs_err": val_avg["median_abs_err"],
        ...
        print(
            ...
            f"q90_width={rec['val_q90_width']:.3f} "
            f"median_abs={rec['val_median_abs_err']:.3f} "
