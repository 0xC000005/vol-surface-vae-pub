...
from diffusion.block_ar.ar_surface_token_flow_matching import (
    ARSurfaceTokenFMConfig,
    ARSurfaceTokenFlowMatching,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="273a-v0 autoregressive latent token state-space flow matching"
    )
    ...
    parser.add_argument("--transition_layers", type=int, default=2)
    parser.add_argument("--transition_heads", type=int, default=4)
    parser.add_argument("--transition_ff_mult", type=int, default=4)
    ...
    cfg = ARSurfaceTokenFMConfig(
        ...
        transition_ff_mult=args.transition_ff_mult,
    ...
    model = ARSurfaceTokenFlowMatching(cfg).to(device)
