#!/usr/bin/env python
"""
Fixed H=1 smoke evaluation for 212d.
"""
...
from experiments.backfill.block_ar.train_212d_h1_state_basis_residual_direct_delta import load_model
from experiments.backfill.block_ar.train_208a_h1_teacher_guided_local_family_student_t import compute_h1_shape_stats


def main() -> None:
    parser = argparse.ArgumentParser(description="212d H=1 smoke eval")
