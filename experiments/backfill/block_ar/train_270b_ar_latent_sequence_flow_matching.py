...
from diffusion.block_ar.ar_latent_sequence_flow_matching import (
    ARLatentSequenceFMConfig,
    ARLatentSequenceFlowMatching,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="270b-v0 autoregressive latent-sequence next-change flow matching")
    ...
    model = ARLatentSequenceFlowMatching(cfg).to(device)
