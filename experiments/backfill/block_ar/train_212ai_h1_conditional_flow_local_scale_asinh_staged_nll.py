#!/usr/bin/env python
"""
212ai: staged exact-NLL fine-tuning of 212ae.
"""
...
def load_model(
    ...
    cfg = payload["config"]
    if cfg["type"] != "minimal_h1_conditional_flow_212ai_local_scale_asinh_staged_nll":
...
def main() -> None:
    parser = argparse.ArgumentParser(description="212ai staged exact-NLL fine-tuning from 212ae")
    ...
    print("212ai staged exact-NLL fine-tuning from 212ae")
