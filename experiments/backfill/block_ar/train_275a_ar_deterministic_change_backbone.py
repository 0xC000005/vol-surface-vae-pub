...
from diffusion.block_ar.ar_deterministic_change_backbone import (
    ARDeterministicBackboneConfig,
    ARDeterministicChangeBackbone,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="275a-v0 deterministic autoregressive next-change backbone"
    )
    parser.add_argument("--hidden_dim", type=int, default=192)
    parser.add_argument("--history_layers", type=int, default=2)
    parser.add_argument("--dropout", type=float, default=0.1)
    parser.add_argument("--change_hidden", type=int, default=128)
    parser.add_argument("--change_layers", type=int, default=2)
    parser.add_argument("--change_dropout", type=float, default=0.1)
    ...
    cfg = ARDeterministicBackboneConfig(
        ...
        change_hidden=args.change_hidden,
        change_layers=args.change_layers,
    ...
    model = ARDeterministicChangeBackbone(cfg).to(device)
