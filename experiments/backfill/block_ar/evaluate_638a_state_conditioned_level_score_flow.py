#!/usr/bin/env python
"""638a: score state-conditioned level-score checkpoints on the IV 11-suite."""
...
def main() -> None:
    ...
    if (
        ...
        raise RuntimeError(f"638a/full-suite alignment failed: {alignment}")
    ...
    results["config"] = {
        "mode": "638a_state_conditioned_level_score_flow",
        ...
        "model_coordinate": payload.get(
            "model_coordinate", "state_conditioned_level_score"
        ),
    ...
    write_markdown_summary(
        out_md,
        "638a State-Conditioned Level-Score Flow Official IV 11-Suite",
