...
from diffusion.block_ar.multiscale_future_logit_path_flow_matching import (
    MultiscaleFutureLogitPathFMConfig,
    MultiscaleFutureLogitPathFlowMatching,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="315a-v0 multiscale future-logit path flow matching"
    )
    ...
    cfg = MultiscaleFutureLogitPathFMConfig(
        history_len=args.history_len,
        future_len=args.future_len,
        n_cells=d,
    ...
    model = MultiscaleFutureLogitPathFlowMatching(cfg).to(device)
