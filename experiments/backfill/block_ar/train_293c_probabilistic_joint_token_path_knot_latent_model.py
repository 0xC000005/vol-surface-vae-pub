...
from diffusion.block_ar.probabilistic_joint_token_path_knot_latent_model import (
    ProbabilisticJointTokenPathKnotLatentModel,
    ProbabilisticJointTokenPathKnotLatentModelConfig,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="293c-v0 probabilistic fixed-horizon joint-token path model with interpolated knot latents"
    )
    ...
    model = ProbabilisticJointTokenPathKnotLatentModel(cfg, codebook.to(device)).to(device)
