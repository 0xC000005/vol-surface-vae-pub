...
from diffusion.block_ar.deterministic_history_memory_world_model import (
    DeterministicHistoryMemoryWorldModel,
    DeterministicHistoryMemoryWorldModelConfig,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="289e-v0 deterministic history-memory world model"
    )
    ...
    model = DeterministicHistoryMemoryWorldModel(cfg).to(device)
