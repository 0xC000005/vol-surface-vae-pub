...
from diffusion.block_ar.probabilistic_joint_token_path_model import (
    ProbabilisticJointTokenPathModel,
    ProbabilisticJointTokenPathModelConfig,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="293a-v0 probabilistic fixed-horizon joint-token path model"
    )
    ...
    model = ProbabilisticJointTokenPathModel(cfg, codebook.to(device)).to(device)
