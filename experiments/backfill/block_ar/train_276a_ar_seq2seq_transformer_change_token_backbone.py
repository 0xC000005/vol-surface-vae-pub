...
from diffusion.block_ar.ar_seq2seq_transformer_change_token_backbone import (
    ARSeq2SeqTransformerChangeTokenBackbone,
    ARSeq2SeqTransformerTokenConfig,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="276a-v0 deterministic tokenized next-change seq2seq backbone"
    )
    ...
    parser.add_argument("--coord_limit", type=float, default=4.0)
    ...
    cfg = ARSeq2SeqTransformerTokenConfig(
        ...
        n_bins=args.n_bins,
        coord_limit=args.coord_limit,
    )
    model = ARSeq2SeqTransformerChangeTokenBackbone(cfg).to(device)
