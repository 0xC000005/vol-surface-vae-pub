...
from diffusion.block_ar.empirical_normal_score_masked_future_path_flow_matching import (
    EmpiricalNormalScoreMaskedFuturePathFMConfig,
    EmpiricalNormalScoreMaskedFuturePathFlowMatching,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="345a empirical-normal-score masked future-path flow matching"
    )
    ...
    model = EmpiricalNormalScoreMaskedFuturePathFlowMatching(cfg).to(device)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        rec = {
            ...
            "val_observed_fraction": val_avg["observed_fraction"],
        ...
        print(
            ...
            f"obs={rec['val_observed_fraction']:.3f} "
