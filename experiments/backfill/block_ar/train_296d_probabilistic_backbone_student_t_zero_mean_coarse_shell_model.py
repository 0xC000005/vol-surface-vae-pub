...
from diffusion.block_ar.probabilistic_backbone_student_t_zero_mean_coarse_shell_model import (
    ProbabilisticBackboneStudentTZeroMeanCoarseShellConfig,
    StudentTZeroMeanCoarseShellCore,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="296d-v0 Student-t zero-mean coarse shell around frozen 277d backbone"
    )
    ...
    parser.add_argument("--nu_max", type=float, default=40.0)
    parser.add_argument("--init_nu", type=float, default=6.0)
    ...
    model = StudentTZeroMeanCoarseShellCore(cfg).to(device)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        rec = {
            ...
            "train_nu_mean": train_avg["nu_mean"],
            "train_nu_min": train_avg["nu_min"],
            ...
            "val_nu_mean": val_avg["nu_mean"],
            "val_nu_min": val_avg["nu_min"],
