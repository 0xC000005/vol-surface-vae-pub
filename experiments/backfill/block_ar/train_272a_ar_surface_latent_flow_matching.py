...
from diffusion.block_ar.ar_surface_latent_flow_matching import (
    ARSurfaceLatentFMConfig,
    ARSurfaceLatentFlowMatching,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="272a-v0 autoregressive latent state-space flow matching"
    )
    ...
    model = ARSurfaceLatentFlowMatching(cfg).to(device)
