...
from diffusion.block_ar.latent_path_bottleneck_diffusion_seq import (
    LatentPathBottleneckDiffusionSeq,
    LatentPathBottleneckDiffusionSeqConfig,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="266c-v0 temporal bottleneck with sequence-aware latent diffusion prior")
    ...
    parser.add_argument("--denoiser_hidden", type=int, default=128)
    parser.add_argument("--denoiser_layers", type=int, default=3)
    parser.add_argument("--denoiser_dropout", type=float, default=0.1)
    parser.add_argument("--timestep_dim", type=int, default=32)
    ...
    cfg = LatentPathBottleneckDiffusionSeqConfig(
        ...
        denoiser_dropout=args.denoiser_dropout,
    ...
    model = LatentPathBottleneckDiffusionSeq(cfg).to(device)
