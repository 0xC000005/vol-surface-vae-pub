...
from diffusion.block_ar.unified_latent_token_future_logit_path_flow_matching import (
    ...
    UnifiedLatentTokenFutureLogitPathFlowMatching,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="313a-v0 unified latent-token future-logit path flow matching"
    )
    ...
    model = UnifiedLatentTokenFutureLogitPathFlowMatching(cfg).to(device)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        print(
            ...
            f"fm={rec['val_fm']:.5f} zstd={rec['val_latent_std']:.3f} "
