...
from diffusion.block_ar.probabilistic_latent_token_model import (
    ProbabilisticLatentTokenConfig,
    ProbabilisticLatentTokenModel,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="267a-v0 probabilistic latent-token scenario generator")
    ...
    model = ProbabilisticLatentTokenModel(cfg).to(device)
