...
from diffusion.block_ar.empirical_normal_score_path_coupling_density import (
    EmpiricalNormalScorePathCouplingConfig,
    EmpiricalNormalScorePathCouplingDensity,
    save_checkpoint,
)
...
from experiments.backfill.block_ar.train_339a_empirical_normal_score_path_flow import (
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="346a empirical-normal-score full-path coupling likelihood"
    )
    ...
    parser.add_argument("--coupling_hidden", type=int, default=768)
    ...
    model = EmpiricalNormalScorePathCouplingDensity(cfg).to(device)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        print(
            ...
            f"target_std={rec['val_target_std']:.3f} "
