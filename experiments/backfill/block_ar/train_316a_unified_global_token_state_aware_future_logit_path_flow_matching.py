...
from diffusion.block_ar.unified_global_token_state_aware_future_logit_path_flow_matching import (
    UnifiedGlobalTokenStateAwareFutureLogitPathFMConfig,
    UnifiedGlobalTokenStateAwareFutureLogitPathFlowMatching,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="316a-v0 unified global-token state-aware future-logit path flow matching"
    )
