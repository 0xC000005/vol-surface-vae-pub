...
from diffusion.block_ar.unified_history_memory_state_aware_future_logit_path_flow_matching import (
    UnifiedHistoryMemoryStateAwareFutureLogitPathFlowMatching,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="312b-v0 unified history-memory state-aware future-logit path flow matching"
    )
    ...
    model = UnifiedHistoryMemoryStateAwareFutureLogitPathFlowMatching(cfg).to(device)
