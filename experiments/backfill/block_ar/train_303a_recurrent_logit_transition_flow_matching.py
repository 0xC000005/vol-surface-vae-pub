...
def main() -> None:
    parser = argparse.ArgumentParser(description="303a-v0 recurrent support-valid logit-transition flow")
    ...
    model = RecurrentLogitTransitionFlowMatching(cfg).to(device)
