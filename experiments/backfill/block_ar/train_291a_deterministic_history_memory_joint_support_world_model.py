...
from diffusion.block_ar.deterministic_history_memory_joint_support_world_model import (
    DeterministicHistoryMemoryJointSupportWorldModel,
    DeterministicHistoryMemoryJointSupportWorldModelConfig,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="291a-v0 deterministic history-memory joint-support world model"
    )
    parser.add_argument("--latent_dim", type=int, default=128)
    parser.add_argument("--history_hidden", type=int, default=128)
    parser.add_argument("--history_layers", type=int, default=2)
    parser.add_argument("--obs_hidden", type=int, default=160)
    parser.add_argument("--context_dim", type=int, default=128)
    parser.add_argument("--nhead", type=int, default=4)
    parser.add_argument("--decoder_hidden", type=int, default=192)
    parser.add_argument("--dropout", type=float, default=0.1)
    parser.add_argument("--support_dim", type=int, default=16)
    parser.add_argument("--support_hidden", type=int, default=96)
    parser.add_argument("--level_weight", type=float, default=1.0)
    parser.add_argument("--change_weight", type=float, default=1.0)
    parser.add_argument("--code_weight", type=float, default=0.25)
    ...
    model = DeterministicHistoryMemoryJointSupportWorldModel(cfg).to(device)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        rec = {
            ...
            "train_code": train_avg["code_loss"],
