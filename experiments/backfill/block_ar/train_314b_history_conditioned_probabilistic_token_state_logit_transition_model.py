...
from diffusion.block_ar.history_conditioned_probabilistic_token_state_logit_transition_model import (
    HistoryConditionedProbabilisticTokenStateLogitTransitionConfig,
    HistoryConditionedProbabilisticTokenStateLogitTransitionModel,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="314b-v0 history-conditioned probabilistic token-state logit transition model"
    )
    ...
    model = HistoryConditionedProbabilisticTokenStateLogitTransitionModel(cfg).to(device)
