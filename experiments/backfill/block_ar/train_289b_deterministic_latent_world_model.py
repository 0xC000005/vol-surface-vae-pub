...
from diffusion.block_ar.deterministic_latent_world_model import (
    DeterministicLatentWorldModel,
    DeterministicLatentWorldModelConfig,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="289b-v0 deterministic latent world model"
    )
    ...
    model = DeterministicLatentWorldModel(cfg).to(device)
