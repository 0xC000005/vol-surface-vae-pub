...
from diffusion.block_ar.axial_mixer_future_logit_path_flow_matching import (
    AxialMixerFutureLogitPathFMConfig,
    AxialMixerFutureLogitPathFlowMatching,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="324c-v0 axial-mixer future-logit path flow matching"
    )
    ...
    parser.add_argument("--token_ff", type=int, default=384)
    ...
    model = AxialMixerFutureLogitPathFlowMatching(cfg).to(device)
