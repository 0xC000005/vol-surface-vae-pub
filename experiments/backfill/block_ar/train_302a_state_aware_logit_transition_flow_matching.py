...
from diffusion.block_ar.logit_transition_state_flow_matching import (
    StateAwareLogitTransitionFMConfig,
    StateAwareLogitTransitionFlowMatching,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="302a-v0 state-aware support-valid logit-transition flow")
    ...
    parser.add_argument("--model_layers", type=int, default=5)
    ...
    model = StateAwareLogitTransitionFlowMatching(cfg).to(device)
