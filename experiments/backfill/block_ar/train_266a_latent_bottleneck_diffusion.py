...
from diffusion.block_ar.latent_bottleneck_diffusion import (
    LatentBottleneckDiffusion,
    LatentBottleneckDiffusionConfig,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="266a-v0 first-principles latent bottleneck diffusion baseline")
    parser.add_argument("--latent_dim", type=int, default=32)
    parser.add_argument("--context_dim", type=int, default=128)
    parser.add_argument("--history_hidden", type=int, default=64)
    parser.add_argument("--future_hidden", type=int, default=64)
    ...
    model = LatentBottleneckDiffusion(cfg).to(device)
