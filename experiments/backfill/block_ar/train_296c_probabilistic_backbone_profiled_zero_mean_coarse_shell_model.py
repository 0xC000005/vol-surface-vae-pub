...
from diffusion.block_ar.probabilistic_backbone_profiled_zero_mean_coarse_shell_model import (
    ProbabilisticBackboneProfiledZeroMeanCoarseShellConfig,
    ProfiledZeroMeanCoarseShellCore,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="296c-v0 profiled zero-mean coarse shell around frozen 277d backbone"
    )
    ...
    model = ProfiledZeroMeanCoarseShellCore(cfg).to(device)
