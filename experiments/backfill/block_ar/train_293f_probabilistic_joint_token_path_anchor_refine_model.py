...
from diffusion.block_ar.probabilistic_joint_token_path_anchor_refine_model import (
    ProbabilisticJointTokenPathAnchorRefineModel,
    ProbabilisticJointTokenPathAnchorRefineModelConfig,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="293f-v0 probabilistic fixed-horizon joint-token path model with anchored coarse support plus knot refinement"
    )
    ...
    parser.add_argument("--refine_scale", type=float, default=0.25)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        rec = {
            ...
            "train_refine_loss": train_avg["refine_loss"],
            ...
            "val_refine_loss": val_avg["refine_loss"],
        ...
        print(
            ...
            f"refine={rec['val_refine_loss']:.4f} "
            f"lr={rec['lr']:.2e} "
            f"time={rec['sec']:.1f}s"
        )
