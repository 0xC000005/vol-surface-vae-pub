...
def main() -> None:
    parser = argparse.ArgumentParser(description="300a-v0 support-valid logit-IV future-level flow")
    ...
    model = LogitLevelFlowMatching(cfg).to(device)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        rec = {
            ...
            "train_logit_std": train_avg["logit_std"],
            "train_logit_abs": train_avg["logit_abs"],
            "train_target_velocity_std": train_avg["target_velocity_std"],
            "val_total": val_avg["total"],
            "val_logit_std": val_avg["logit_std"],
            "val_logit_abs": val_avg["logit_abs"],
        ...
        print(
            ...
            f"logit_std={rec['val_logit_std']:.3f} "
            f"logit_abs={rec['val_logit_abs']:.3f} "
            f"lr={rec['lr']:.2e} "
            f"time={rec['sec']:.1f}s"
        )
