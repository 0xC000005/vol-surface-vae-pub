...
def main() -> None:
    parser = argparse.ArgumentParser(description="304b-v0 joint token logit-transition flow with implied state")
    ...
    model = StateAwareJointTokenLogitTransitionFlowMatching(cfg).to(device)
