...
Smallest decisive follow-up to 252a.

Run types:
    - 253a-base: dynamic factor state + hard idio budget
...
from diffusion.block_ar.dynamic_change_factor_ssm import (
    DynamicChangeFactorSSM,
    DynamicFactorSSMConfig,
    config_to_dict,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="253a dynamic change-space factor model")
    parser.add_argument("--variant", choices=["base", "ec"], default="base")
    ...
    cfg = DynamicFactorSSMConfig(
        ...
        use_error_correction=(args.variant == "ec"),
