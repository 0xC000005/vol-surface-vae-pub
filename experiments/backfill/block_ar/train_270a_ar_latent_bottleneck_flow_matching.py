...
from diffusion.block_ar.ar_latent_bottleneck_flow_matching import (
    ARLatentBottleneckFMConfig,
    ARLatentBottleneckFlowMatching,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="270a-v0 autoregressive latent-bottleneck next-change flow matching")
    ...
    model = ARLatentBottleneckFlowMatching(cfg).to(device)
