#!/usr/bin/env python
"""
Fixed H=1 smoke evaluation for 210e.
"""
...
from experiments.backfill.block_ar.train_210e_h1_categorical_latent_transformer import load_model


def main() -> None:
    parser = argparse.ArgumentParser(description="210e H=1 smoke eval")
