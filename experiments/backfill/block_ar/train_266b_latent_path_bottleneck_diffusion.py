...
from diffusion.block_ar.latent_path_bottleneck_diffusion import (
    LatentPathBottleneckDiffusion,
    LatentPathBottleneckDiffusionConfig,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="266b-v0 temporal bottleneck latent diffusion baseline")
    ...
    model = LatentPathBottleneckDiffusion(cfg).to(device)
