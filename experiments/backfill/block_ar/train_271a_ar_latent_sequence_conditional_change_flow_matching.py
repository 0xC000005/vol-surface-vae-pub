...
from diffusion.block_ar.ar_latent_sequence_conditional_change_flow_matching import (
    ARLatentSequenceConditionalChangeFMConfig,
    ARLatentSequenceConditionalChangeFlowMatching,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="271a-v0 autoregressive latent-sequence conditional-change flow matching"
    )
    ...
    parser.add_argument("--transition_hidden", type=int, default=128)
    parser.add_argument("--transition_layers", type=int, default=3)
    parser.add_argument("--transition_dropout", type=float, default=0.1)
    parser.add_argument("--time_dim", type=int, default=32)
    parser.add_argument("--step_dim", type=int, default=16)
    ...
    model = ARLatentSequenceConditionalChangeFlowMatching(cfg).to(device)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        rec = {
            ...
            "train_target_std": train_avg["target_std"],
