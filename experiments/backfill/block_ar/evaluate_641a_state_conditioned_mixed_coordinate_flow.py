#!/usr/bin/env python
"""641a: score mixed-coordinate checkpoints on the IV 11-suite."""
...
def main() -> None:
    ...
    if (
        ...
        raise RuntimeError(f"641a/full-suite alignment failed: {alignment}")
    ...
    results["config"] = {
        "mode": "641a_state_conditioned_mixed_coordinate_flow",
    ...
    write_markdown_summary(
        out_md,
        "641a Mixed-Coordinate Flow Official IV 11-Suite",
