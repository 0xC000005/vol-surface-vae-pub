...
from diffusion.block_ar.deterministic_token_latent_world_model import (
    DeterministicTokenLatentWorldModel,
    DeterministicTokenLatentWorldModelConfig,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="289d-v0 deterministic token-latent world model"
    )
    parser.add_argument("--latent_dim", type=int, default=96)
    parser.add_argument("--n_latent_tokens", type=int, default=4)
    parser.add_argument("--history_hidden", type=int, default=128)
    parser.add_argument("--history_layers", type=int, default=2)
    parser.add_argument("--obs_hidden", type=int, default=128)
    ...
    model = DeterministicTokenLatentWorldModel(cfg).to(device)
