...
from diffusion.block_ar.probabilistic_joint_token_path_support_increment_residual_model import (
    ProbabilisticJointTokenPathSupportIncrementResidualModel,
    ProbabilisticJointTokenPathSupportIncrementResidualModelConfig,
    save_checkpoint,
)
...
def build_residual_codebook(
    ...
    residual_coords = (
        ...
        - scaffold_increment_coords_for_training(hist_norm, fut_norm, coarse_scaffold, change_scale_eps)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="293h-v0 probabilistic fixed-horizon joint-token path model with scaffold-increment residual daily law"
    )
    ...
    cfg = ProbabilisticJointTokenPathSupportIncrementResidualModelConfig(
        history_len=args.history_len,
        future_len=args.future_len,
        n_cells=d,
