...
def build_topk_batch(
    ...
    return top_idx, top_scores, query_z, anchored_candidates
...
def main() -> None:
    parser = argparse.ArgumentParser(description="283b-v0 anchored future-path reweighting trained with weighted CRPS")
        ...
        if val_metrics["loss"] < best_val:
            ...
            save_checkpoint(
                ...
                extra={
                    ...
                    "training_objective": "weighted_crps_anchored_support",
                },
            )
