...
from diffusion.block_ar.unified_state_aware_future_logit_path_flow_matching import (
    UnifiedStateAwareFutureLogitPathFlowMatching,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="312a-v0 unified state-aware future-logit path flow matching"
    )
    ...
    model = UnifiedStateAwareFutureLogitPathFlowMatching(cfg).to(device)
