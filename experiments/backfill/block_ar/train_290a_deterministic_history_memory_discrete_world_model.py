...
from diffusion.block_ar.deterministic_history_memory_discrete_world_model import (
    DeterministicHistoryMemoryDiscreteWorldModel,
    DeterministicHistoryMemoryDiscreteWorldModelConfig,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="290a-v0 deterministic history-memory discrete-output world model"
    )
    ...
    parser.add_argument("--change_limit", type=float, default=0.5)
    ...
    model = DeterministicHistoryMemoryDiscreteWorldModel(cfg).to(device)
