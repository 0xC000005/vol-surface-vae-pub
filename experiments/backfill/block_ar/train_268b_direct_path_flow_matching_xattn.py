...
from diffusion.block_ar.direct_path_flow_matching_xattn import (
    DirectPathCrossAttnFMConfig,
    DirectPathCrossAttnFlowMatching,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="268b-v0 direct path FM with cross-attentive history conditioning")
    parser.add_argument("--model_hidden", type=int, default=192)
    ...
    model = DirectPathCrossAttnFlowMatching(cfg).to(device)
