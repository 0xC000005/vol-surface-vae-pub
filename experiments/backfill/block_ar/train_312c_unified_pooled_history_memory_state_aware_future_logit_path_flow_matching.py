...
from diffusion.block_ar.unified_pooled_history_memory_state_aware_future_logit_path_flow_matching import (
    UnifiedPooledHistoryMemoryStateAwareFutureLogitPathFlowMatching,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="312c-v0 unified pooled-history-memory state-aware future-logit path flow matching"
    )
    ...
    model = UnifiedPooledHistoryMemoryStateAwareFutureLogitPathFlowMatching(cfg).to(device)
