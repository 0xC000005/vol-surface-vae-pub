...
def main() -> None:
    parser = argparse.ArgumentParser(description="304a-v0 joint time-cell token logit-transition flow")
    ...
    model = JointTokenLogitTransitionFlowMatching(cfg).to(device)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        print(
            ...
            f"transition_std={rec['val_transition_std']:.3f} lr={rec['lr']:.2e} time={rec['sec']:.1f}s"
        )
