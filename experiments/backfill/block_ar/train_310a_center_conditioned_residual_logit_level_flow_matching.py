...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="310a-v0 center-conditioned residual logit-level flow matching"
    )
    ...
    model = CenterConditionedResidualLogitLevelFlowMatching(cfg).to(device)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        print(
            ...
            f"total_logit_std={rec['val_total_logit_std']:.3f} "
