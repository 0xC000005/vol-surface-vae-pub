...
from diffusion.block_ar.probabilistic_backbone_zero_mean_coarse_shell_model import (
    ProbabilisticBackboneZeroMeanCoarseShellConfig,
    ZeroMeanCoarseShellCore,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="296b-v0 probabilistic zero-mean coarse shell around frozen 277d backbone"
    )
    ...
    model = ZeroMeanCoarseShellCore(cfg).to(device)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        print(
            ...
            f"daily_scale={rec['val_pred_scale_daily_mean']:.4f} "
