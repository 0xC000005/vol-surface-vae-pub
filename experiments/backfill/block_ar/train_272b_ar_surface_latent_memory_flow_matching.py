...
from diffusion.block_ar.ar_surface_latent_memory_flow_matching import (
    ARSurfaceLatentMemoryFMConfig,
    ARSurfaceLatentMemoryFlowMatching,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="272b-v0 autoregressive latent state-space flow matching with memory"
    )
    ...
    model = ARSurfaceLatentMemoryFlowMatching(cfg).to(device)
