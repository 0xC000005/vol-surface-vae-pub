...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="296f-v0 budgeted multiresolution zero-mean shell around frozen 277d backbone"
    )
    ...
    model = BudgetedMultiresolutionZeroMeanCoarseShellCore(cfg).to(device)
