...
def main() -> None:
    parser = argparse.ArgumentParser(description="268a-v0 direct conditional future-path flow matching")
    ...
    model = DirectPathFlowMatching(cfg).to(device)
