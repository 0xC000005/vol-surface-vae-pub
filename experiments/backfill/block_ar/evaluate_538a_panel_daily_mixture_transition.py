#!/usr/bin/env python
"""Evaluate 538a panel daily mixture transition law through the IV 11-suite."""
...
from diffusion.block_ar.panel_daily_mixture_transition_model import load_model  # noqa: E402
...
def main() -> None:
    ...
    write_markdown_summary(
        out_md,
        "538a Panel Daily Mixture Transition Law",
