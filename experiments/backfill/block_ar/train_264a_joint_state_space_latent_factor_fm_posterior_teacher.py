...
from diffusion.block_ar.joint_state_space_latent_factor_fm_posterior_teacher import (
    JointStateSpaceLatentFactorFMPosteriorTeacher,
    JointStateSpaceLatentFactorFMPosteriorTeacherConfig,
    save_checkpoint,
)
...
def fm_step(
    model: JointStateSpaceLatentFactorFMPosteriorTeacher,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="264a-v0 posterior-teacher state-space latent-factor FM")
    ...
    cfg = JointStateSpaceLatentFactorFMPosteriorTeacherConfig(
    ...
    model = JointStateSpaceLatentFactorFMPosteriorTeacher(cfg).to(device)
