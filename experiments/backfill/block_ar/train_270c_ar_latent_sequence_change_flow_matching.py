...
from diffusion.block_ar.ar_latent_sequence_change_flow_matching import (
    ARLatentSequenceChangeFMConfig,
    ARLatentSequenceChangeFlowMatching,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="270c-v0 autoregressive latent-sequence change-decoding flow matching"
    )
    ...
    model = ARLatentSequenceChangeFlowMatching(cfg).to(device)
