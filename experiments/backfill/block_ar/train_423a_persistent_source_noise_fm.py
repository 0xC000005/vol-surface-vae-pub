#!/usr/bin/env python
"""423a: persistent source-noise FM fine-tune for the 392a AR frontier."""
...
def main() -> None:
    ...
    parser.add_argument("--path_source_corr", type=float, default=0.35)
    ...
    print(f"path_source_corr={model.cfg.path_source_corr:.3f}")
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        print(
            ...
            f"val={rec['val_total']:.5f} trans_std={rec['val_transition_std']:.3f} "
            f"trans_abs={rec['val_transition_abs']:.3f} "
            f"rho={rec['path_source_corr']:.3f} "
