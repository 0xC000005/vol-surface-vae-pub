#!/usr/bin/env python
"""
Fixed H=1 smoke evaluation for 210g.
"""
...
from experiments.backfill.block_ar.train_210g_h1_vq_latent_transformer import load_model


def main() -> None:
    parser = argparse.ArgumentParser(description="210g H=1 smoke eval")
