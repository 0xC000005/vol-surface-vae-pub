...
from diffusion.block_ar.direct_change_flow_matching import (
    DirectChangeFMConfig,
    DirectChangeFlowMatching,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="268c-v0 direct conditional future-change flow matching")
    ...
    model = DirectChangeFlowMatching(cfg).to(device)
