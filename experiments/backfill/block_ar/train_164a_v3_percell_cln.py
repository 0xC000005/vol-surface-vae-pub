#!/usr/bin/env python
"""
164a_v3_percell: Per-Cell ConditionalNorm — Break Broadcast Noise Bottleneck (RC20.2 H2a)
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"164a_v3_percell: Per-Cell CLN — Break Broadcast Bottleneck (RC20.2 H2a)")
    print(f"{'='*60}")
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        # ── Save best model ──
        config_dict = {
            "type": "ar_spatial_transformer_164a_v3_percell",
            "encoder": {
