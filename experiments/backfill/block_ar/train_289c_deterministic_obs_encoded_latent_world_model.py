...
from diffusion.block_ar.deterministic_obs_encoded_latent_world_model import (
    DeterministicObsEncodedLatentWorldModel,
    DeterministicObsEncodedLatentWorldModelConfig,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="289c-v0 deterministic observation-encoded latent world model"
    )
    ...
    model = DeterministicObsEncodedLatentWorldModel(cfg).to(device)
