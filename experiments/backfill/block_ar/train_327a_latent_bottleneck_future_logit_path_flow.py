...
from diffusion.block_ar.latent_bottleneck_future_logit_path_flow import (
    LatentBottleneckFutureLogitPathFlow,
    LatentBottleneckFutureLogitPathFlowConfig,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="327a-v0 learned future-bottleneck latent path flow"
    )
    ...
    parser.add_argument("--target_mode", choices=("level", "transition"), default="level")
    ...
    model = LatentBottleneckFutureLogitPathFlow(cfg).to(device)
