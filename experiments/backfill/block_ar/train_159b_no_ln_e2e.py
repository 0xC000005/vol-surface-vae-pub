#!/usr/bin/env python
"""
159b: No-LN CLN + E2E (RC19-H2a-S2)

No-LN CLN with E2E training (4010 windows vs 441 for residual).
Tests whether no-LN mechanism works with more data and corrected
understanding (encoder norm ratio is 0.97, not 1.6x).

159a showed turb/calm=1.164 transiently on val (441 windows, residual).
Does E2E (4010 windows) sustain it longer?
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"159b: No-LN CLN + E2E (RC19-H2a-S2)")
    print(f"{'='*60}")
