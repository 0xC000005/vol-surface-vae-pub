#!/usr/bin/env python
"""
Fixed H=1 smoke evaluation for 208a.
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="208a H=1 smoke eval")
    ...
    for start in range(0, history_01.shape[0], args.batch_size):
        ...
        samp = model.sample_next_iv(history_01[start:end], n_samples=args.eval_samples)
    ...
    family_loader = DataLoader(TensorDataset(history_01, target_01), batch_size=args.batch_size, shuffle=False)
    ...
    checks = {
        ...
        "family_top1_ok": float(family_stats["val_family_top1_mean"]) >= 0.40,
    }
