#!/usr/bin/env python
"""
263c-v0: 263b with a bounded history-anchored latent scale path.
"""
...
from diffusion.block_ar.joint_state_space_latent_factor_fm_ec_scale_anchor import (
    JointStateSpaceLatentFactorFMECScaleAnchor,
    JointStateSpaceLatentFactorFMECScaleAnchorConfig,
    save_checkpoint,
)
...
def fm_step(
    model: JointStateSpaceLatentFactorFMECScaleAnchor,
    ...
    *,
    ...
    change_loss = F.smooth_l1_loss(model.decode_residual_change_coord(zero_eps, cond), target_coord)
    ...
    metrics = {
        ...
        "scale_anchor_mean": cond["scale_anchor"].mean().detach(),
    }
    return loss, metrics
...
def main() -> None:
    parser = argparse.ArgumentParser(description="263c-v0 263b + history-anchored latent scale path")
    ...
    parser.add_argument("--scale_anchor_max", type=float, default=0.5)
    ...
    cfg = JointStateSpaceLatentFactorFMECScaleAnchorConfig(
        ...
        scale_anchor_max=args.scale_anchor_max,
    )
    model = JointStateSpaceLatentFactorFMECScaleAnchor(cfg).to(device)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        rec = {
            ...
            "train_scale_anchor": train_avg["scale_anchor_mean"],
            ...
            "val_scale_anchor": val_avg["scale_anchor_mean"],
        ...
        print(
            ...
            f"ec={rec['val_ec_gain']:.3f} anchor={rec['val_scale_anchor']:.3f} "
