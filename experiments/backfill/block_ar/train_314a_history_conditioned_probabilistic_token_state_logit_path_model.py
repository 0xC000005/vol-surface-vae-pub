...
from diffusion.block_ar.history_conditioned_probabilistic_token_state_logit_path_model import (
    HistoryConditionedProbabilisticTokenStateLogitPathConfig,
    HistoryConditionedProbabilisticTokenStateLogitPathModel,
    save_checkpoint,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="314a-v0 history-conditioned probabilistic token-state logit path model"
    )
    ...
    model = HistoryConditionedProbabilisticTokenStateLogitPathModel(cfg).to(device)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        rec = {
            ...
            "val_recon_logit_abs": val_avg["recon_logit_abs"],
        ...
        print(
            ...
            f"qstd={rec['val_post_std']:.3f} logit_std={rec['val_future_logit_std']:.3f} "
            f"recon_abs={rec['val_recon_logit_abs']:.3f} "
