"""
Validate VAE Teacher Forcing Sequences for Context60 Model
...
def main():
    ...
    if not base_dir.exists():
        ...
        print(f"  Example: bash experiments/backfill/context60/teacher_forcing/run_generate_all_tf_sequences.sh {args.sampling_mode}")
        return
    ...
    if passed_files == total_files:
        ...
        print(f"  bash experiments/backfill/context60/teacher_forcing/run_generate_all_tf_sequences.sh {args.sampling_mode}")
