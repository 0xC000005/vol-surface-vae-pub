# Autonomous Loop Protocol (ORIGINAL — Karpathy-style)

> **WARNING**: This file describes the ORIGINAL greedy autoresearch loop. SKILL.md's
> HEDA loop SUPERSEDES this protocol. Key differences:
> - This file uses `git reset --hard` to revert failures. The HEDA approach NEVER
>   reverts commits — failed experiments stay as permanent history.
> - This file has no "investigate why" step. HEDA requires deep investigation.
> - This file has no theory-driven hypothesis generation.
>
> Kept for reference only. Follow SKILL.md for the actual loop.
