...
ci_insample = pd.read_csv("models_backfill/vae_prior_ci_insample_16yr.csv")
ci_oos = pd.read_csv("models_backfill/vae_prior_ci_oos_16yr.csv")
...
cointegration = pd.read_csv("tables/cointegration_preservation/summary_comparison.csv")
...
# Save summary
output_file = "models_backfill/oracle_vs_vae_prior_comparison.csv"
