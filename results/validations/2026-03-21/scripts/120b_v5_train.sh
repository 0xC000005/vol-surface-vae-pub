#!/bin/bash
# Training: Exp 120b_v5 — IS Width Fix at λ_IS=0.5
# Purpose: First test of IS width fix on noise-free MLP (over-corrected)
# Result: 3/8 suites — IS too strong, coverage 72%
set -euo pipefail
