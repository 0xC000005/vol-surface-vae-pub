...
def _small_model() -> GenericStateConditionedMixedCoordinateFlowMatching:
...
def test_mixed_coordinate_loss_and_sampling_are_finite() -> None:
...
def test_mixed_coordinate_level_score_channels_respect_level_support() -> None:
...
def test_mixed_coordinate_rejects_out_of_range_level_score_channels() -> None:
    cfg = GenericStateConditionedMixedCoordinateFMConfig(
        history_len=2,
        future_len=1,
        n_cells=3,
    ...
    try:
        GenericStateConditionedMixedCoordinateFlowMatching(cfg)
