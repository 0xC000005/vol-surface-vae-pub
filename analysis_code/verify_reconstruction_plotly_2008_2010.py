"""
Interactive Plotly visualization of quantile model reconstruction using encoded latents (z_mean).
...
def create_interactive_plot(all_predictions, all_ground_truth, model_names):
    ...
    for col, model_name in enumerate(model_names):
        ...
        for row, (grid_i, grid_j, grid_label) in enumerate(grid_points):
            ...
            # Add metrics as text trace instead of annotation (works better with subplots)
    ...
    # Update layout
    fig.update_layout(
        title_text='Reconstruction Verification: Using Encoded z_mean (2008-2010 Financial Crisis)<br><sub>Interactive - Zoom, Pan, Hover for Details</sub>',
        height=1200,
        width=1800,
        hovermode='closest',
        showlegend=True,
...
def main():
    print("="*60)
    print("INTERACTIVE PLOTLY VERIFICATION")
    ...
    # Save as HTML
    output_file = 'reconstruction_verification_2008_2010_interactive.html'
